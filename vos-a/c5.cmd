...
Alle servers dienen State 'RUNNING' en Health 'OK' te hebben. 
Er staan geen VOS-gerelateerde zaken in de restart of unactivated changes lijst. 
Indien van toepassing moeten er managed servers herstart worden.
